...
namespace Dtn\Wrapping\Model\Quote\Address\Total;
...
class GiftWrapFee extends \Magento\Quote\Model\Quote\Address\Total\AbstractTotal
{
     ...
     * @param \Dtn\Wrapping\Helper\Data $helperData
     */
    public function __construct(
        ...
        \Dtn\Wrapping\Helper\Data $helperData
    ) {
    ...
    public function collect(
        ...
        if (!empty($collection->getData()) || $collection->getData()) {
            ...
            $giftWrapItems  = $collectionData->getGiftWrapItems();
