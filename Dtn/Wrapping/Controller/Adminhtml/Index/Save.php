...
namespace Dtn\Wrapping\Controller\Adminhtml\Index;
...
class Save extends \Magento\Backend\App\Action
{
    ...
    {
        return $this->_authorization->isAllowed('Dtn_Wrapping::save');
    }
    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            $model = $this->_objectManager->create('Dtn\Wrapping\Model\GiftWrap');
            ...
            try {
                $imageHelper = $this->_objectManager->get('Dtn\Wrapping\Helper\Data');
